...
export default function OrthodoxDashboardPage() {
  return (
    <main className="orthodox-pattern min-h-screen px-4 py-8 md:px-8">
      ...
      <h1 className="font-heading text-4xl text-[var(--text-secondary)] md:text-5xl">Orthodox Temple</h1>
      <p className="mt-3 max-w-3xl text-lg text-[var(--text-primary)]/88">
        Enter by the ancient path of prayer, Scripture, liturgy, and the witness of the saints. Explore our complete collection of resources below.
      </p>
        ...
        {orthodoxSections.map((section) => (
          <section key={section.path}>
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="font-heading text-2xl text-[var(--text-secondary)]">{section.title}</h2>
            </div>
